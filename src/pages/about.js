      ...
      <div className="max-w-5xl mx-auto p-4">
        ...
        <div className="bg-light shadow-lg rounded-2xl p-6 hover:shadow-xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:bg-rose-50">
          <p className="text-dark text-lg">
            ...
            customers&apos; unique needs. Our mission is to exceed expectations
            by delivering the finest customized products while upholding the
            highest standards of professionalism. Continuously evolving and
            growing, we are guided by our core values of integrity, innovation,
            and excellence. We are grateful for your interest in our company and
            eagerly anticipate the opportunity to collaborate and create a
            lasting partnership.
          </p>
        </div>
